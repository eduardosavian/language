...
public class SimplexParser extends Parser {
	...
	public static final int
		...
		RULE_sliceIndicator = 9, RULE_typeExpression = 10, RULE_typeEstablishment = 11, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"typeExpression", "typeEstablishment", "funcDeclaration", "field", "fieldList", 
	...
	public static class TypeExpressionContext extends ParserRuleContext {
		...
		public TypeEstablishmentContext typeEstablishment() {
			return getRuleContext(TypeEstablishmentContext.class,0);
		}
	...
	@SuppressWarnings("CheckReturnValue")
	public static class TypeEstablishmentContext extends ParserRuleContext {
		public TerminalNode ID() { return getToken(SimplexParser.ID, 0); }
		public TypeEstablishmentContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_typeEstablishment; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SimplexParserListener ) ((SimplexParserListener)listener).enterTypeEstablishment(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SimplexParserListener ) ((SimplexParserListener)listener).exitTypeEstablishment(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SimplexParserVisitor ) return ((SimplexParserVisitor<? extends T>)visitor).visitTypeEstablishment(this);
			else return visitor.visitChildren(this);
		}
	}

	public final TypeEstablishmentContext typeEstablishment() throws RecognitionException {
		TypeEstablishmentContext _localctx = new TypeEstablishmentContext(_ctx, getState());
		enterRule(_localctx, 22, RULE_typeEstablishment);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(135);
